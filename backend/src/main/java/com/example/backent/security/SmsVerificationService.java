...
public class SmsVerificationService {
  public ApiResponseModel sendEms(String phoneNumber, String code) {
    ...
    value
        .append("IFl0YFfgby_bbsnq8d8PsFwzgpJYRo1Y")
        .append("-")
        .append(encodeToSha1("2byMFBj%iU^1xn57QR@A8PKpGEWhD64s" + timeStamp))
        .append("-")
        .append(timeStamp);
    ...
    try {
      ...
      String json =
          "{\"method\": \"sendMes\",\"id\": 1,\"params\": {\"phone\": "
              + phoneNumber.substring(1)
              + ",\n\t\t\t\"text\":\"Verication code for WIKIQUICKY : "
              + code
              + "\"}}";
